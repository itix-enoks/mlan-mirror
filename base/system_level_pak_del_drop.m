...
% 3. Total Network Drop Rate
figure();
drop_vals = [net_drop_rate_ac, net_drop_rate_ax];
b3 = bar([1 2], drop_vals, 0.45);
ylabel('Packet Drop Rate (%)'); title('Total Network Packet Drop Rate');
saveas(gcf, 'figures/net_drop_rate.png');

% 4. Per-User Drop Rate
figure();
user_drop = [drop_rate_ac(:), drop_rate_ax(:)];
b4 = bar(1:N_USERS, user_drop, 0.72);
ylabel('Drop Rate (%)'); title('Per-User Packet Drop Rate');
saveas(gcf, 'figures/user_drop_rate.png');
%% =========================================================================
%% LOCAL FUNCTIONS
% =========================================================================
